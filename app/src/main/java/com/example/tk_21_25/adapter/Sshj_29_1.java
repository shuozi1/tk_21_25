...
public class Sshj_29_1 extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.sshj_29_1, container, false);
    }
...
//        System.out.println("阈值:"+yz);
       if (list.get(list.size()-1)>200){
           colors.add(Color.RED);
           TongZhi("当前PM2.5:",pm25);
       }else {
...
//            builder.setContentTitle("通知");
    ...
    private void initView() {
        mLcSshj291 = (LineChart) getActivity().findViewById(R.id.lc_sshj_29_1);
    }
}
